...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1 = new gui.JTextFieldHint(new JTextField(),"user-icon","Digite seu Usuario");
        ;
        jTextField2 = new javaapplication2.JPassWordFieldHint(new JPasswordField(),"padlock","Digite sua Senha");
        ;
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(0, 338));
